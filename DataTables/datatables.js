 ...
 *   https://datatables.net/download/#bs4/dt-1.10.18/cr-1.5.0/r-2.2.2/rr-1.2.4
 *
 * Included libraries:
 *   DataTables 1.10.18, ColReorder 1.5.0, Responsive 2.2.2, RowReorder 1.2.4
 */
...
(function( $, window, document, undefined ) {
	...
	function _fnBuildAjax( oSettings, data, fn )
	{
        ...
        //console.log('data:');
        //console.log(base64_encode(json_encode(data)));

		var baseAjax = {
			"data": data /*'data='+encodeURIComponent(base64_encode(json_encode(data)))*/,
			"success": function (json) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs4/dt-1.10.18/cr-1.5.0/r-2.2.2/rr-1.2.4",
